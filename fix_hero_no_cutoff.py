...
new_idx_hero = '''<section id="inicio" class="hero" style="position: relative; overflow: hidden; min-height: 85vh; display: flex; align-items: center; padding: 9.5rem 0 4.5rem 0; background: #0a0e17 url('assets/hero-bg.jpg') center/cover no-repeat;">
    <div class="hero-overlay" style="position: absolute; inset: 0; width: 100%; height: 100%; background: radial-gradient(circle at 25% 50%, rgba(10, 14, 23, 0.82) 0%, rgba(10, 14, 23, 0.45) 60%, rgba(10, 14, 23, 0.15) 100%); z-index: 1; pointer-events: none;"></div>
    ...
    <div class="container hero-content" style="position: relative; z-index: 2; width: 100%; max-width: 880px; margin-left: 0; text-align: left;">
        <div style="display: flex; align-items: center; gap: 1.2rem; margin-bottom: 1.2rem; flex-wrap: wrap;">
            ...
            <div class="hero-accred-group" style="display: inline-flex; align-items: center; gap: 1rem;">
                <img src="assets/inn-logo-white.png" alt="INN CHILE OI-323" class="hero-accred-img" style="height: 40px; width: auto; object-fit: contain; filter: drop-shadow(0 2px 8px rgba(0,0,0,0.8));">
                <img src="assets/iso-logo-white.png" alt="ISO 17020:2012" class="hero-accred-img" style="height: 40px; width: auto; object-fit: contain; filter: drop-shadow(0 2px 8px rgba(0,0,0,0.8));">
            </div>
        </div>
...
print("Updated Hero in index.html with new fleet inspection photo and no cutoffs!")
...
service_heroes = {
    "servicio-flotas.html": {
        ...
        "poster": "assets/hero-acreditacion-flotas.jpg",
    ...
    "servicio-talleres.html": {
        ...
        "poster": "assets/hero-certificacion-talleres.jpg",
...
print("Successfully fixed Hero layout across all pages!")
